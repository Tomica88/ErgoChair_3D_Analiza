...
const Hero = () => {
  ...
  return (
    <div id="hero" className="relative h-screen max-w-5xl mx-auto flex flex-col p-4 pt-8 lg:pt-32 md:p-16">
      ...
      <Link href="#catalog" className="absolute bottom-24 left-1/2 transform -translate-x-1/2 flex flex-row items-center px-6 py-2 mx-auto mb-16 mt-auto border border-slate-400 rounded-xl text-sm text-slate-400">
